...
def find_duplicate_files_by_size(directory):
    ...
    min_size = 10 * 1024 * 1024  # 10 megabytes in bytes
...
if __name__ == "__main__":
    directory_path = "/Volumes/X"
    duplicates = find_duplicate_files_by_size(directory_path)

    if duplicates:
        print("Potential duplicate files based on size (ignoring files smaller than 10MB):")
